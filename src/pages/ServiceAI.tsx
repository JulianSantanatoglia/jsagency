...
const ServiceAI = () => {
  const includes = [
    'Chatbots/asistentes virtuales conversacionales',
  ...
  const idealFor = [
    ...
    'Negocios que quieren responder 24/7',
    'Equipos que dedican mucho tiempo a tareas manuales',
    'Startups que necesitan escalar sin aumentar costos',
    'Negocios que buscan mejorar la experiencia del cliente'
  ];
  ...
  const packages = [
    ...
    },
    {
      ...
      features: [
        ...
        'Múltiples canales (Web, WhatsApp, redes)',
    ...
    },
    {
      ...
      price: 'Desde €3.500',
      features: [
        'Sistema completo de automatizaciones',
        'Múltiples bots y flujos',
        ...
        <div className="max-w-4xl mx-auto text-center">
          <ScrollReveal direction="up" delay={0}>
            ...
            <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed font-body">
              Automatizamos tareas y respuestas para ahorrar tiempo y cerrar más ventas.
            </p>
          </ScrollReveal>
        </div>
      </section>
