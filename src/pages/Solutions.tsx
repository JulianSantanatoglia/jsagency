...
import { UtensilsCrossed, Video, ArrowRight } from 'lucide-react';
  ...
  const solutions = [
    {
      id: 'divly',
      title: 'Divly',
      description: 'Solución digital para bares y restaurantes.',
    ...
    {
      id: 'visual',
      title: 'Visual 360 + Drone',
      description: 'Paquete visual para inmobiliarias/hostelería/marcas.',
      icon: Video,
      color: 'purple',
      link: '/solutions/visual',
      cta: 'Ver solución'
    }
  ];
        ...
        <ScrollReveal direction="up" delay={0}>
          <header className="text-center mb-16 md:mb-20 pt-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-display mb-6 text-primary-dark dark:text-white tracking-tight">
              Nuestras <span className="text-accent-cyan">Soluciones</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-500 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed font-body">
              Soluciones verticales pensadas para sectores específicos.
            </p>
          </header>
        </ScrollReveal>
              ...
              >
                <div className={`flex items-start gap-4 mb-4`}>
                  <div className={`flex-shrink-0 w-14 h-14 rounded-2xl ${
                    solution.color === 'emerald' ? 'bg-emerald-50 dark:bg-emerald-900/30' :
                    'bg-purple-50 dark:bg-purple-900/30'
                  } flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                    <solution.icon size={28} className={`${
                      solution.color === 'emerald' ? 'text-emerald-600 dark:text-emerald-400' :
