        ...
        <div className="max-w-7xl mx-auto">
          <ScrollReveal direction="up" delay={0}>
            <div className="text-center mb-12">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-emerald-50 dark:bg-emerald-900/30 mb-6">
                <UtensilsCrossed size={32} className="text-emerald-600 dark:text-emerald-400" />
              </div>
              ...
              <p className="text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto font-body font-light leading-relaxed">
                Solución digital para bares y restaurantes. Carta digital inteligente con divisor para comensales.
              </p>
            </div>
          </ScrollReveal>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <ScrollReveal direction="up" delay={0.1}>
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700">
                <h3 className="text-2xl font-bold font-display mb-4 text-primary-dark dark:text-white">
                  El Problema
                </h3>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <ScrollReveal direction="up" delay={0}>
            <h2 className="text-3xl md:text-4xl font-bold font-display mb-6 text-primary-dark dark:text-white">
              ¿Querés algo similar para tu negocio?
            </h2>
            ...
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 px-8 py-4 bg-accent-cyan text-white font-semibold text-lg rounded-xl hover:bg-cyan-600 transition-all shadow-lg shadow-cyan-500/20 hover:shadow-xl hover:shadow-cyan-500/30 font-body"
            >
              Hablemos
              <ArrowRight size={20} />
            </Link>
