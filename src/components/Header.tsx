    ...
    <header className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md border-b border-gray-200 z-50" role="banner">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex justify-between items-center">
        <div className="flex items-baseline gap-2 font-display">
          <a href="#home" className="focus:outline-none rounded-lg">
        ...
        <nav className="hidden lg:flex gap-6 items-center" role="navigation" aria-label={t('a11y.mainNavigation')}>
          ...
          <a 
            href="#contacto" 
            className="px-6 py-2.5 bg-accent-cyan text-white rounded-xl font-semibold text-sm uppercase tracking-wide hover:bg-cyan-500 hover-lift shadow-md shadow-cyan-500/20 hover:shadow-lg hover:shadow-cyan-500/25 focus:outline-none"
          >
            {t('nav.contact')}
          </a>
        </nav>
      ...
      >
        <nav className={`flex flex-col p-4 pb-6 space-y-4 transition-all duration-300 ${
          isMenuOpen ? 'delay-100' : 'delay-0'
            ...
            <a 
              href="#contacto" 
              className={`px-6 py-2.5 bg-accent-cyan text-white rounded-xl font-bold text-base uppercase tracking-wide hover:bg-cyan-500 transition-all duration-300 text-center focus:outline-none transform ${
