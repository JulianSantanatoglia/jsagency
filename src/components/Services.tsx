...
const Services = () => {
  ...
  const servicesContent = {
    es: {
      ...
      tours: {
        title: 'Visitas Virtuales 360°',
        description: 'Visitas inmersivas especialmente para inmobiliarias, eventos, bares y restaurantes.',
        features: [
          'Visitas virtuales para inmobiliarias y propiedades',
          'Experiencias para eventos, bares y restaurantes',
        ...
        cta: 'Quiero una visita virtual'
      },
      drone: {
        title: 'Servicios de Drone',
        description: 'Fotografía y video aéreo para inmobiliarias, eventos, paisajes y publicidad.',
        features: [
          'Fotografía y video para inmobiliarias',
          ...
          'Piloto certificado A1/A3 y registro vigente',
    ...
    en: {
      ...
      tours: {
        ...
        description: 'Immersive visits especially for real estate, events, bars and restaurants.',
        features: [
          'Virtual visits for real estate and properties',
          'Experiences for events, bars and restaurants',
        ...
        cta: 'I want a virtual visit'
      },
      drone: {
        title: 'Drone Services',
        description: 'Aerial photography and video for real estate, events, landscapes and advertising.',
        features: [
          'Photography and video for real estate',
          'Event and celebration coverage',
          'Landscape and natural environment capture',
          'Advertising and promotional content',
          'Professional editing ready to publish',
          'A1/A3 certified pilot and active registration',
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <ScrollReveal direction="up" delay={100}>
          {/* Desktop: Contenedor único con todas las cards */}
          <div className="hidden md:block w-full bg-white dark:bg-slate-800 rounded-2xl border border-slate-200/80 dark:border-slate-700/50 shadow-lg p-4">
            {/* Contenido dividido en 4 secciones - Desktop */}
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-4">
              {services.map((service, index) => (
                <article 
                  key={service.id}
                  className="group relative flex flex-col h-full bg-slate-50/30 dark:bg-slate-700/30 rounded-xl p-6 border border-slate-200/50 dark:border-slate-600/30 hover:bg-slate-50/50 dark:hover:bg-slate-700/50 transition-all duration-300"
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  {/* Barra de color individual en la parte superior de cada card */}
                  <div className={`h-1.5 mb-4 rounded-t-lg -mx-6 -mt-6 ${
                    service.color === 'blue' ? 'bg-gradient-to-r from-blue-500 via-cyan-500 to-blue-600' :
                    service.color === 'emerald' ? 'bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-600' :
                    service.color === 'purple' ? 'bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700' :
                    'bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700'
                  }`}></div>
                  {/* Contenido de la card */}
                  <div className="flex flex-col h-full">
                  {/* Header con icono y título - Altura fija para alineación perfecta */}
                  <div className="mb-6 h-[200px] flex flex-col">
                    ...
                    <p className="text-sm md:text-[15px] text-slate-600 dark:text-slate-400 font-body leading-relaxed flex-1">
                      {service.description}
                    </p>
                  </div>

                  {/* Precio destacado - Altura fija para alineación */}
                  ...
                  {/* Features con diseño limpio - Flex-1 para ocupar espacio disponible */}
          ...
          {/* Mobile: Cards individuales con su propia barra de color */}
          <div className="md:hidden grid grid-cols-1 gap-y-8">
            {services.map((service, index) => (
              <article 
                key={service.id}
                className="group relative flex flex-col bg-white dark:bg-slate-800 rounded-2xl border border-slate-200/80 dark:border-slate-700/50 overflow-hidden shadow-lg hover:bg-slate-50/50 dark:hover:bg-slate-700/20 transition-colors duration-300"
                style={{ animationDelay: `${index * 100}ms` }}
              >
                {/* Barra de color individual para mobile */}
